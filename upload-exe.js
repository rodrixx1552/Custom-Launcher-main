...
const FILES = [
    { name: 'LosPapus-v0.5.10.zip', path: path.join(__dirname, 'dist', 'LosPapus-v0.5.10.zip') },
    { name: 'LosPapus-Launcher-Setup-v0.5.10.exe', path: path.join(__dirname, 'dist', 'LosPapus Launcher Setup 0.5.10.exe') }
];
